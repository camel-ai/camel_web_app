...
class RAGRequest(BaseModel):
    ...
    """
    RAGType: str = Field(..., description="The type of RAG process to be performed (e.g., 'embedding', 'graph').")
    fileUrl: str = Field(..., description="The URL of the documents to be processed.")
    ...
    topNumber: int = Field(..., description="The number of documents to retrieve.")

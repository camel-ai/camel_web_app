...
class Settings(BaseModel):
    ...
    yourPlatformType: str = Field(default="", description="The platform type selected by the user (e.g., OPENAI, MISTRALAI).")
    yourModelType: str = Field(default="", description="The model type selected by the user (e.g., GPT_4, MISTRAL_LARGE_2).")
